  ...
  shiny::sidebarLayout(
    ...
    sidebarPanel = shiny::sidebarPanel(
      ...
      shiny::HTML(base::paste0(
        "Note : Le 10 mars 2023, le Johns Hopkins Coronavirus Resource Center cessera a mis fin à ses activités.",
...
server = function(input, output){
  ...
  output$map = leaflet::renderLeaflet({
    ...
    leaflet::leaflet() %>%
      leaflet::addTiles(
        attribution = paste0(
          "<a href=https://odf.u-paris.fr/fr/offre-de-formation/master-XB/sciences-humaines-et-sociales-SHS/geographie-amenagement-environnement-et-developpement-K2VO0KVP/master-gaed-parcours-teledetection-et-geomatique-appliquees-a-l-environnement-tgae-m2-JRWBKY4F.html target='_blank'>UPC/GAED/M2-TGAE</a> | ",
          "<a href='mailto:mariemekebe935@gmail.com'>© Copyright 2024, Marieme KEBE</a>"
        )
      ) %>%
      leaflet::setView(
