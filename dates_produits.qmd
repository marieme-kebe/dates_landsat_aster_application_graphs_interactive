...
plotly::ggplotly(
  ...
  theme(
    ...
    axis.text.x=element_text(size=16, face="bold", hjust=.5), # étiquette de l'axe des abscisses
    axis.text.y=element_text(size=16, face="bold", hjust=.5),
    ...
    legend.text=element_text(size=16, margin=margin(l=-.02, unit="cm")),
...
plotly::ggplotly(
  ...
  theme(
    ...
    strip.background = element_rect(fill="white", color="gray", linewidth=1),
    axis.title=element_blank(),    # omettre l'axe des ordonnées
    axis.text.x=element_text(size=7, face="bold", hjust=.5), # étiquette de l'axe des abscisses
